...
| Language | Nations | `source_reference/` status | Priority |
|---|---|---|---|
| **Russian** | Russia (~25M eff., or absent at some cities per the Davis/Zhongshan tier-inconsistency flagged above) | Present, **Phase 1 in progress — largest corpus in the project** (`Russian`; ~1,049,000 words extracted across 153 `established/` files so far, 204-file/3.6GB source corpus, ~19 of ~45 prioritized Wave 3 vision-read sources done; see `datasets/Russian/`) | 🔴 **HIGH PRIORITY** |
